...
class TaskController extends AsyncNotifier<void> {
  ...
  Future<void> markTaskAsCompleted({
    ...
    state = await AsyncValue.guard(() async {
      ...
      // We need child name for the message. Fetch basic info or passed in UI?
      // For simplicity, generic message or fetch quickly.
      // Let's assume generic for now or we would need to fetch Child Profile here which adds overhead.
      // "Your child" works.
      final notification = NotificationEntity(
        id: '', // Generated by Repo
        title: 'Mission Completed! 🎉',
        message: 'A mission has been completed! (+ $points KP)',
