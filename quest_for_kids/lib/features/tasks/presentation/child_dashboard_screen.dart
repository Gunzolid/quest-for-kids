...
class _ChildDashboardScreenState extends ConsumerState<ChildDashboardScreen> {
  ...
  Widget _buildMissionCard(TaskEntity task, Color color, String childName) {
    return Card(
      elevation: 4,
              ...
              child: task.imageUrl != null && task.imageUrl!.isNotEmpty
                  ? Image.network(
                      ...
                      errorBuilder: (context, error, stackTrace) => Center(
                        child: Icon(Icons.task_alt, size: 48, color: color),
                      ),
                    )
                  : Center(child: Icon(Icons.task_alt, size: 48, color: color)),
            ),
          ),
          // Content Section
          Expanded(
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    // Confirm dialog? Or just do it? Let's confirm.
                    showDialog(
                      context: context,
                      builder: (context) => AlertDialog(
                        title: const Text('Clear History?'),
                        content: const Text(
                          'This will remove all completed missions from this list.',
                        ),
                        actions: [
                          TextButton(
                            onPressed: () => Navigator.pop(context),
